  ...
  template: `
    <form class="tesla-battery" [formGroup]="tesla">
      ...
      <div class="tesla-battery__notice">
        <p>
          La cantidad real de rango que experimenta variará en función de sus condiciones de uso particulares.
           Vea cómo ciertas condiciones de uso pueden afectar su rango en nuestro modelo de simulación.
        </p>
        <p>
          El alcance del vehículo puede variar dependiendo de la configuración del vehículo,
           edad y estado de la batería, estilo de conducción y condiciones operativas, ambientales y climáticas.
        </p>
      </div>
    </form>
  `,
